                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="update-customer-form" class="forms-sample" method="POST"
                            action="{{ route('update-customerBlob', ['id' => $customer->idcustomer]) }}"
                            ...
                            <div class="form-group text-center">
                                ...
                                <div id="photo-preview-container" class="mb-3"
                                    ...
                                    @if($customer->foto_blob)
                                        <img id="existing-photo-preview"
                                            src="{{ is_resource($customer->foto_blob) ? stream_get_contents($customer->foto_blob) : $customer->foto_blob }}"
                                            class="img-fluid"
